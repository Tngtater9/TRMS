...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.getUserByName = function (username) {
    ...
    UsersService.prototype.getUsersByTitle = function (title) {
        return __awaiter(this, void 0, void 0, function () {
            var params;
            return __generator(this, function (_a) {
                switch (_a.label) {
                ...
                switch (_a.label) {
                    case 0:
                        params = {
                            ...
                            UpdateExpression: 'set password = :p, avail_funds = :af, pending_funds = :pf, awarded_funds = :award, dept = :d, title = :t, supervisor = :s, dept_head = :dh',
                            ExpressionAttributeValues: {
                                ':af': user.avail_funds,
